...
function gateKeeper(req, res, next) {
  const justParsed = queryString.parse(req.get('x-username-and-password'))
  console.log(justParsed)
  const user = justParsed.user || null;
  const pass = justParsed.pass || null;
